...
bindMinus: function(e) {
    ...
    var userId="";
    wx.request({
      url: app.server.hostUrl + '/Api/Shopping/minus',
      method:'post',
      data: {
        user_id: userId,
        num:num,
...
bindPlus: function(e) {
    ...
    var userId="";
    wx.request({
      url: app.server.hostUrl + '/Api/Shopping/plus',
      method:'post',
      data: {
        user_id: userId,
        num:num,
    ...
    wx.showModal({
      ...
      success: function(res) {
        res.confirm && wx.request({
          url: app.server.hostUrl  + '/Api/Shopping/delete',
          method:'post',
          data: {
            cart_id: cardId,
          },
...
// 数据案例
  loadProductData:function(){
    ...
    var userId="";
    wx.request({
      url: app.server.hostUrl + '/Api/Shopping/index',
      method:'post',
      data: {
        user_id:userId
      },
      ...
      success: function (res) {
        ...
        var productData = res.data.product;
        that.setData({
          carts:cart,
